...
<div>
    ...
    @foreach ($commonTimes as $commonTime)
        <div class="modal fade" id="editModal{{ $commonTime->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{ $Action }}/save-edit/{{ $commonTime->id }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Start Time</label>
                                <input type="text" class="form-control" name="start" {{ $commonTime->startTime }}>
                            </div>

                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">End Time</label>
                                <input type="text" class="form-control" name="end" {{ $commonTime->endTime }}>
                            </div>
